...
|Адрес подсети (256 возможных подсетей) |Диапазон хостов (65 534 возможных узла в каждой подсети) |Широковещательный адрес |
|-|-|-|
|**10.0**.0.0 **/16** |	**10.0**.0.1 - **10.0**.255.254 |**10.0**.255.255 |
|**10.1**.0.0 **/16** |**10.1**.0.1 - **10.1**.255.254 |**10.1**.255.255 |
|**10.2**.0.0 **/16** |**10.2**.0.1 - **10.2**.255.254 |**10.2**.255.255 |
|**10.3**.0.0 **/16** |	**10.3**.0.1 - **10.3**.255.254 |**10.3**.255.255 |
|**10.4**.0.0 **/16** |**10.4**.0.1 - **10.3**.255.254 |**10.4**.255.255  |
|**10.5**.0.0 **/16** |**10.5**.0.1 - **10.3**.255.254 |**10.5**.255.255  |
|**10.6**.0.0 **/16** |**10.6**.0.1 - **10.3**.255.254 |**10.6**.255.255  |
|**10.7**.0.0 **/16** |**10.7**.0.1 - **10.3**.255.254 |**10.7**.255.255  |
|... |... |... |
...
|Адрес подсети (65,536 возможных подсетей) |Диапазон хостов (254 возможных узла в каждой подсети) |Широковещательный адрес |
|-|-|-|
...
|Длина префикса|Маска подсети|Маска подсети в двоичном формате (n = сеть; h = узел)|# Количество подсетей |# Количество хостов |
|-|-|-|-|-|
...
|/30 |255.255.255.252 |nnnnnnnn.nnnnnnnn.nnnnnnnn.**nnnnnn**hh
11111111.11111111.11111111.**111111**00 |**64** | 2|
...
[Открыть описание в PDF](./assets/11.5.5-packet-tracer---subnet-an-ipv4-network_ru-RU.pdf)

[Скачать файл для Packet Tracer](./assets/11.5.5-packet-tracer---subnet-an-ipv4-network_ru-RU.pka)
...
Часть 1. Создать основные подключения, доступ к интерфейсу командной строки (CLI) и изучить справку

Часть 2. Изучить режимы EXEC

Часть 3. Настроить часы
...
Во второй части этого упражнения вы переключитесь в привилегированный режим EXEC и выполните дополнительные команды.

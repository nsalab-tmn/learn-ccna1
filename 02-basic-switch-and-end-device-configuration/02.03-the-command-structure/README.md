...
* **Ключевое слово** — это параметр, определенный в операционной системе (на рисунке **ip protocols**).   
...
**Примечание:** Хотя клавиша **Delete** обычно удаляет символ справа от приглашения, структура команд IOS не распознает ее.
...
Посмотрите видео, демонстрирующее различные горячие клавиши и клавиши быстрого вызова.

...
<!--
показывает рисунок того, как устройства используют транспортный уровень для перемещения данных между приложениями в модели TCP/IP
-->
...
<!--
На ПК одновременно работают несколько сетевых приложений, включая почтовый клиент, клиент обмена мгновенными сообщениями, веб-страницы веб-браузера, потоковое видео и клиент видеоконференции.
-->
...
<!--
Несколько диалогов сетевых приложений отправляются по сети частями, известными как сегменты или датаграммы.
-->
...
<!--
Сегменты, передаваемые по сети, имеют свои собственные заголовки транспортного уровня с управляющей информацией, которая помогает сегментам достигать правильных целевых приложений и хостов.
-->
...
<!--
анимация показывает подключение к FTP-серверу, инициированное трехсторонним рукопожатием TCP, и сегменты данных, учитываемые с использованием номеров последовательности и подтверждений
-->
...
<!--
анимация показывает подключение к TFTP-серверу с использованием UDP датаграмм, которые отправляются без порядкового номера или подтверждения
-->
...
<!--
перечисляет различия между UDP: быстрый, низкий уровень накладных расходов, отсутствие подтверждений, отсутствие повторной отправки и TCP: надежный, подтверждает данные, повторно отправляет потерянные данные и предоставляет данные с номерами последовательности
-->

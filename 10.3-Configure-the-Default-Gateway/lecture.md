...
Чтобы настроить шлюз IPv4 по умолчанию на коммутаторе, используйте команду глобальной конфигурации **ip default-gateway** *ip-address*. Значение *ip-address*, которое указано, является IPv4-адресом локального интерфейса маршрутизатора, подключенного к коммутатору.
...
[Открыть описание в PDF](./assets/10.3.4-packet-tracer---connect-a-router-to-a-lan_ru-RU.pdf)

[Скачать файл для Packet Tracer](./assets/10.3.4-packet-tracer---connect-a-router-to-a-lan_ru-RU.pdf)
...
[Открыть описание в PDF](./assets/10.3.5-packet-tracer---troubleshoot-default-gateway-issues_ru-RU.pdf)

[Скачать файл для Packet Tracer](./assets/10.3.5-packet-tracer---troubleshoot-default-gateway-issues_ru-RU.pka)

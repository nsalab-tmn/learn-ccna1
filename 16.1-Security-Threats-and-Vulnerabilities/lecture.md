...
**Кража информации** - взлом компьютера для получения конфиденциальной информации. Информация может быть использована или продана для различных целей. 
...
|Уязвимость|	Описание|
|-|-|
|Отсутствие утвержденной политики безопасности|	Если политика безопасности не утверждена, то обеспечить ее согласованное применение и соблюдение невозможно.|

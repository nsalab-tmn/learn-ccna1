...
<!--
На диаграмме показана сеть OSI, канальный и физический уровни. Он также показывает уровень данных LLC и подуровни MAC и различные протоколы LAN/WAN. В верхней части диаграммы находится сетевой уровень и протокол сетевого уровня.  Ниже находится канальный уровень его подуровни. Верхний подуровень является подуровнем LLC, как указано в IEEE 802.2.  Далее идет подуровень MAC с тремя столбцами, представляющими различные типы сетевых технологий. Первый столбец - это Ethernet IEEE 802.3 в верхней части подуровня MAC.  Ниже приведены различные стандарты Ethernet для Fast Ethernet, Gigabit Ethernet и т. Д., Которые охватывают нижнюю часть подуровня MAC и весь физический уровень OSI. Первый столбец - это Ethernet IEEE 802.11 в верхней части подуровня MAC.  Ниже приведены различные стандарты WLAN для разных типов беспроводной связи, которые охватывают нижнюю часть подуровня MAC и весь физический уровень OSI. Первый столбец - это Ethernet IEEE 802.15 в верхней части подуровня MAC. Ниже приведены различные стандарты WPAN для Bluetooth, RFID и т. Д., Которые охватывают нижнюю часть подуровня MAC и весь физический уровень OSI.
-->
...
<!--
На диаграмме показаны поля кадра Ethernet. Слева направо поля и их длина: Преамбула и SFD, 8 байтов; MAC-адрес назначения, 6 байтов; MAC-адрес источника, 6 байт; Тип / длина, 2 байта; данные 45 - 1500 байт; и FCS, 4 байта. За исключением первого поля, общее количество байтов в остальных полях составляет от 64 до 1518.
-->

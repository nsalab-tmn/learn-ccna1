...
Посмотрите анимацию, иллюстрирующую наиболее распространенные типы вредоносного ПО.
...
На этой анимации хакер ищет исходную информацию о целевом объекте. Можно использовать различные инструменты, в том числе поиск Google, веб-сайт организаций, Whois и многое другое.

![](./assets/16.2.2-1.gif)

### **Эхо-тестирование адресов**

На этой анимации злоумышленник теперь может инициировать проверку связи, чтобы определить, какие IP-адреса являются активными.
![](./assets/16.2.2-2.gif)

### **Сканирование портов**

На этой анимации изображен хакер, выполняющий сканирование портов с помощью программы Nmap для обнаружения активных IP-адресов.
...
При атаке с злоупотреблением доверия злоумышленник использует несанкционированные привилегии для получения доступа к системе, что может поставить под угрозу цель. Посмотрите пример злоупотребления доверием.
...
Просмотрите анимацию DDoS-атаки.
...
[Открыть описание в PDF](./assets/16.2.6-lab---research-network-security-threats_ru-RU.pdf)

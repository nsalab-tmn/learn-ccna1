...
![](./assets/14.6.1.png "Восстановление порядка сегментов TCP на узле назначения")
...
![](./assets/14.6.5.png "Пример размера окна TCP")
...
![](./assets/14.6.7.png "Управление перегрузкой TCP")

...
[Открыть файл PDF](./assets/12.9.1-packet-tracer---implement-a-subnetted-ipv6-addressing-scheme_ru-RU.pdf)

[Открыть файл Packet tracer](./assets/12.9.1-packet-tracer---implement-a-subnetted-ipv6-addressing-scheme_ru-RU.pka)
...
[Открыть файл PDF](./assets/12.9.2-packet-tracer---configure-ipv6-addresses-on-network-devices---physical-mode_ru-RU.pdf)

[Открыть файл Packet tracer](./assets/12.9.2-packet-tracer---configure-ipv6-addresses-on-network-devices---physical-mode_ru-RU.pka)

**Лабораторное оборудование**

[Открыть файл PDF](./assets/12.9.2-lab---configure-ipv6-addresses-on-network-devices_ru-RU.pdf)

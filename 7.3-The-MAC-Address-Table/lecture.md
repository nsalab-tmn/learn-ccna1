...
<!--
Четыре хоста, A - D, подключены к коммутатору на портах 1 - 4. Узел A с MAC-адресом 00-0A (упрощенный в данном примере) подключен к коммутатору на порту 1. Узел A отправляет кадр с MAC-адресом назначения 00-0D. MAC-адрес источника кадра — 00-0A.  Коммутатор сопоставляет порт 1 MAC-адрес 00-0A в своей таблице MAC-адресов.
-->
...
<!--
Четыре хоста, A - D, подключены к коммутатору на портах 1 - 4. Кадр имеет MAC-адрес назначения 00-0D и MAC-источник 00-0A. Единственная запись в таблице MAC-адресов сопоставляет порт 1 с MAC-адресом 00-0A. Кадр пересылается через порты 2, 3 и 4.
-->
...
<video width="768" height="432" controls>
  <source src="./assets/7.3.4.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
</video>
...
<video width="768" height="432" controls>
  <source src="./assets/7.3.5.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'>
</video>

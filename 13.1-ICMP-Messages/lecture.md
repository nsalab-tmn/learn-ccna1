...
<!--
анимация хоста 1, отправляющего эхо-запрос ping ICMP на хост 2 и эхо-ответ ICMP с хоста 2 обратно на хост 1
-->
...
<!--
PC1 отправляет сообщение запроса маршрутизатора RS FF02::2 адрес многоадресной рассылки всех маршрутизаторов, который достигнет R1.
-->
...
<!--
PC1 отправляет сообщение запроса соседа NS на свой собственный вновь настроенный IPv6-адрес, чтобы убедиться, что в сети нет другого узла с тем же IPv6-адресом, это обнаружение дубликатов адресов DAD.
-->
...
<!--
R1 отправляет сообщение запроса соседа NS на адрес IPv6 PC1s для получения его MAC-адреса. PC1 отвечает своим MAC-адресом в объявлении соседа NA.
-->

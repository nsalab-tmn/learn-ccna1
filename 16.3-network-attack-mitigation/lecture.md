...
![](./assets/16.3.1.png)
<!-- /courses/itn-dl/aeed7cc4-34fa-11eb-ad9a-f74babed41a6/af250782-34fa-11eb-ad9a-f74babed41a6/assets/2e804f73-1c25-11ea-81a0-ffc2c49b96bc.svg -->
...
<!--
На рисунке изображена сеть кампуса. Вверху изображено облако, символизирующее Интернет.
подключенный к маршрутизатору, обозначенный как VPN. VPN-маршрутизатор подключен к брандмауэру
ASA. Брандмауэр имеет два дополнительных подключения: одно к IPS и
другой к коммутатору. Коммутатор подключен к DHCP-серверу, почтовому серверу,
и ESA/WSA. IPS подключен к многоуровневому коммутатору. Многоуровневый
коммутатор имеет подключение к серверу AAA, а также к двум коммутаторам уровня 2
подключен к  другому многоуровневому коммутатору. Второй многоуровневый коммутатор также
имеет подключения к тем же коммутаторам уровня 2, что создает избыточность. Ниже
коммутатора уровня 2 показаны  три ноутбука и три компьютера, которые помечены как хосты.
-->
...
<!--
The figure shows the Windows Update screen for a Windows 10 pc.
-->
...
![](./assets/16.3.4.png)
<!-- /courses/itn-dl/aeed7cc4-34fa-11eb-ad9a-f74babed41a6/af250782-34fa-11eb-ad9a-f74babed41a6/assets/2e8160e1-1c25-11ea-81a0-ffc2c49b96bc.svg -->

<!--
На рисунке показаны две кредитные карты, одна поверх другой рядом с
выпиской по кредитной карте Прямоугольник вокруг чисел на верхней кредитной карте с
текстом: Аутентификация - Кто вы? Второй прямоугольник вокруг кредитного
лимит в выписке по кредитной карте с текстом: Авторизация -  Сколько вы можете
тратить? Третий прямоугольник вокруг транзакционной части кредитной карты
с конечной суммой с текстом:  учет - На что вы это  потратили?
-->
...
![](./assets/16.3.5-1.png)
<!-- /courses/itn-dl/aeed7cc4-34fa-11eb-ad9a-f74babed41a6/af250782-34fa-11eb-ad9a-f74babed41a6/assets/2e81af03-1c25-11ea-81a0-ffc2c49b96bc.svg -->

<!--
На рисунке показан прямоугольник с надписью «Внутренняя сеть». Внутри прямоугольника есть
ПК. Снаружи и справа от прямоугольника есть брандмауэр. Справа 
 от брандмауэра, есть облако с надписью, Интернет. Есть две стрелки,
один означает трафик, уходящий с компьютера, проходящий через брандмауэр и выходящий в
Интернет Вторая стрелка указывает, что брандмауэр разрешает трафик из
Интернет на ПК. На рисунке показан другой прямоугольник с надписью «Внутренняя сеть». Внутри прямоугольника есть
ПК. Снаружи и справа от прямоугольника есть брандмауэр. Справа
от брандмауэра, есть облако с надписью, Интернет. Стрелка
указывая из Интернета на брандмауэр с X, означающим, что трафику
исходящему из сети Интернет запрещено  входить во внутреннюю сеть.
-->
...
![](./assets/16.3.5-2.png)
<!-- /courses/itn-dl/aeed7cc4-34fa-11eb-ad9a-f74babed41a6/af250782-34fa-11eb-ad9a-f74babed41a6/assets/2e81d614-1c25-11ea-81a0-ffc2c49b96bc.svg -->

<!--
На рисунке показан прямоугольник с надписью «Внутренняя сеть». Внутри прямоугольника есть
ПК. Снаружи и справа от прямоугольника есть брандмауэр. Справа
от брандмауэра, есть облако с надписью, Интернет. Над брандмауэром
есть сервер DMZ внутри прямоугольника. Есть две стрелки, одна идет
с компьютера через брандмауэр на сервер DMZ, а другая, идущая из
Интернета через брандмауэр на сервер DMZ.
-->

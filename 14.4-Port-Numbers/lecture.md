...
![](./assets/14.4.1.png)
<!-- /courses/itn-dl/aeed7cc0-34fa-11eb-ad9a-f74babed41a6/af241d22-34fa-11eb-ad9a-f74babed41a6/assets/2e5fcf22-1c25-11ea-81a0-ffc2c49b96bc.svg -->

<!--
показывает поля заголовка порта источника и порта назначения, которые составляют 2 байта каждый
-->
...
![](./assets/14.4.2.png)
<!-- /courses/itn-dl/aeed7cc0-34fa-11eb-ad9a-f74babed41a6/af241d22-34fa-11eb-ad9a-f74babed41a6/assets/2e5ff633-1c25-11ea-81a0-ffc2c49b96bc.svg -->

<!--
показывает, что компьютер делает как веб-запрос, так и FTP-запрос на сервер. Запросы используют номера портов источника и назначения, которые идентифицируют хост-компьютер и запрашиваемую службу приложений соответственно
-->
...
В таблице показаны некоторые общеизвестные порты и связанные с ними приложения.

...
|Адрес подсети (256 возможных подсетей)|	Диапазон хостов (65,534 возможных хоста в подсети)|	Широковещательный адрес|
|-|-|-|
...
|Адрес подсети (65,536 возможных подсетей)|	Диапазон хостов (254 возможных хоста в подсети)|	Широковещательный адрес|
|-|-|-|
...
### Разделение на подсети с префиксом /24

|Длина префикса|	Маска подсети|	Маска подсети в двоичном формате (n = сеть; h = узел)|	# Количество подсетей|	# Хостов в каждой подсети|
|-|-|-|-|-|
...
[Открыть описание в PDF](./assets/11.7.5-packet-tracer---subnetting-scenario_ru-RU.pdf)

[Скачать файл для Packet Tracer](./assets/11.7.5-packet-tracer---subnetting-scenario_ru-RU.pka)
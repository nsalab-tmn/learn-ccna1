...
```json
{
    "title": "Проверьте своё понимание темы: компоненты сети", <--- сюда ставим заголовок квиза
        ...
        },
        {
            ...
            "answers": [
                ...
                },
				{
                    "answer": "Серверы",
                    "correct": false,
                    "comment": "Маршрутизаторы и коммутаторы являются промежуточными устройствами" <--- дублируем комментарий для всех правильных ответов
                },
                {
                    "answer": "Коммутаторы",
                    "correct": true                    

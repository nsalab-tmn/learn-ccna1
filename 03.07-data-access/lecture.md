...
[Установка программы Wireshark (описание в PDF)](./assets/3.7.9-lab---install-wireshark.pdf)

<!-- 3.7.10 -->

[Использование программы Wireshark для просмотра сетевого трафика (описание в PDF)](./assets/3.7.10-lab---use-wireshark-to-view-network-traffic.pdf)

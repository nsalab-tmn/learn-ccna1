...
![Схема базового разделения на подсети](./assets/11.8.3-2.png "Схема базового разделения на подсети")
...
![](./assets/11.8.3-4.png "Неиспользуемые адреса в подсетях WAN")
...
![](./assets/11.8.4-3.png "Базовая схема VLSM-разделения на подсети")
...
![](./assets/11.8.4-4.png "Схема VLSM-разделения на подсети")

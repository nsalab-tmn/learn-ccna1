...
Центр окружности помечен как Интранет и имеет доступ только компании. Окружающий это еще один круг с надписью Экстранет и доступен поставщикам, клиентам и сотрудникам. Окружающий это еще один круг, помеченный в Интернет и доступный всему миру.

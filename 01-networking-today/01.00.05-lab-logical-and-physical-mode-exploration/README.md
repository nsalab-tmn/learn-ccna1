...
5.  Под коммутаторами в **стойке** находится беспроводная точка доступа с именем **Access_Point**. Беспроводные точки доступа используют беспроводное подключение для подключения к другим устройствам. Переключитесь в **логический** режим. 
...
4.  Ответьте **no** на вопрос и нажмите клавишу ВВОД, чтобы попасть в командную строку на **Router**.

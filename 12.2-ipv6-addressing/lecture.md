...
Преобразуйте адрес IPv6 в краткую (без ведущих нулей) и сжатую формы. Введите буквы в нижнем регистре. Нажмите кнопку Далее, чтобы перейти к следующему адресу.
